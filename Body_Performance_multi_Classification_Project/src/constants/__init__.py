...
PROJECT_NAME: str = 'Body_Performance_multi_Classification_Project'
TARGET_COL: str = 'class'
PRED_TYPE: str = 'binary_classification' # regression, binary_classification, multi_classification
# NUM_MULTI_CLASS: int = 4 # Number of classes in multi-class classification

PIPELINE_NAME: str = 'body_performance_pipeline' 
