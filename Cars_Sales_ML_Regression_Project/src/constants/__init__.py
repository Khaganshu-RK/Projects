...
PROJECT_NAME: str = 'Cars_Sales_ML_Regression_Project'
TARGET_COL: str = 'sellingprice'
PRED_TYPE: str = 'regression' # regression, binary_classification, multi_classification

PIPELINE_NAME: str = 'cars_sales_pipeline'
